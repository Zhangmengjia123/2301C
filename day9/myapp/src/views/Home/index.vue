...
<template>
    <div v-bind:class="{'dark':isDark,'light':!isDark}">
        ...
        <ul style="display: flex;flex-wrap: wrap;">
            <li v-for="(item, index) in list1" :key="index" style="padding:5px ;width: 170px;"
                @click="$router.push(`/mygoods?id=${item.id}`)">
        ...
        <div @click="bian"
            style="position: fixed;right: 15px;bottom: 100px;background-color: #f2f2f2;border-radius: 50%;padding: 10px;">
            <img style="width:30px ;height: 30px;" src="../../assets/月亮.png" alt="">
        </div>
